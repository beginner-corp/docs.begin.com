const localURI = 'http://localhost:4445'
const stagingURI = 'https://staging.docs.begin.com'
const productionURI = 'https://docs.begin.com'

export default function BeginDocsURI (path) {
  path = path || ''
